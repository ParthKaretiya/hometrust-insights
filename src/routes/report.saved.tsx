    ...
    <PageShell>
      <div className="mx-auto max-w-7xl px-4 py-10 md:px-6">
        <div className="mb-8 flex items-end justify-between gap-3">
          ...
          <Button asChild>
            <Link to="/report/search">New report</Link>
          </Button>
        </div>
        ...
        {reports.length === 0 ? (
          <Card className="flex flex-col items-center justify-center gap-3 p-16 text-center">
            ...
            <p className="max-w-sm text-sm text-muted-foreground">
              Generate your first neighborhood report — they'll appear here.
            </p>
            <Button asChild className="mt-2">
              <Link to="/report/search">Search neighborhoods</Link>
            </Button>
          </Card>
        ) : (
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <div className="mt-1 text-xs text-muted-foreground">
                      Saved {new Date(r.generatedAt).toLocaleDateString()}
                    </div>
                  </div>
                </div>
                <div className="mt-4 flex gap-2">
                  <Button asChild size="sm" className="flex-1 gap-1.5">
                    <Link to="/report/result" search={{ location: r.locality.id }}>
