...
function SignupPage() {
  ...
  const submit = (e: React.FormEvent) => {
    ...
    navigate({ to: role === "broker" ? "/broker/dashboard" : role === "admin" ? "/admin/dashboard" : "/report/search" });
  };
      ...
      <div className="mx-auto flex max-w-md flex-col px-4 py-16">
        <Card className="p-7">
          ...
          <form onSubmit={submit} className="mt-6 space-y-4">
            <div><Label htmlFor="e">Email</Label><Input id="e" type="email" value={email} onChange={(e) => setEmail(e.target.value)} className="mt-1.5" /></div>
